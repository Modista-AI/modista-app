...
import { useRouter } from 'next/router';
import { useEffect, useState } from 'react';
import { HomeIcon, ArchiveIcon, CloudUploadIcon, LightBulbIcon, UserIcon } from '@heroicons/react/outline';
...
const Layout = ({ children }) => {
  ...
  return (
    <>
      ...
      <main className="min-h-screen">{children}</main> {/* Removed padding at the top */}
    </>
  );
};
